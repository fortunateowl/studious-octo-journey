...
filename = 'Adult_Logit_Model1_Scaling.pkl'
...
filename = 'Adult_Logit_Model1.sav'
...
Adult_test.loc[:, 'income_>50K_lg_predict'] = Output.AccuracyMeasures(Adult_test.loc[:, 'income_>50K_actual'], Adult_test.loc[:, 'income_>50K_lg_prob'], thresh, "Logistic Model 1")
